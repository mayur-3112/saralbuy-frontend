...
const TrendingCategory = ({ categories }) => {
  ...
  return (
    <div className="px-4 py-12 max-w-[1600px] mx-auto">
        ...
        {categories &&
          categories.map((category, idx) => (
            ...
            >
              ...
              <div className="absolute right-0 bottom-0 w-3.5 h-3.5 bg-orange-600 scale-0 group-hover:scale-100 transition-transform duration-200 origin-bottom-right rounded-tl-md"></div>
